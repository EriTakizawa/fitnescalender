...
export class WeekThreeFriday extends Component{
    ...
    onChangeEventWeekThreeFriday(e){
       this.setState ({userInput:e});
        console.log(e)
    }

    addItemWeekThreeFriday(input){
        if (input === ""){
    ...
    deleteItemWeekThreeFriday(){
        let listArray = this.state.fitnessActivities;
        listArray = [];
        this.setState({fitnessActivities:listArray})
    }

    onFormSubmitWeekThreeFriday(e){
        e.preventDefault();
    }
    render(){
        return <div>
            <form onSubmit = {this.onFormSubmitWeekThreeFriday}>
                <table>
                    
                    <tr>
<td>
    <input type="text" placeholder="Write your fitness activity for today?" 
                    onChange={(e) => {this.onChangeEventWeekThreeFriday(e.target.value)}}
                    ...
                    <button onClick={() => this.addItemWeekThreeFriday(this.state.userInput)}>Add</button>    
                    <button onClick={() => this.deleteItemWeekThreeFriday(this.state.userInput)}>Delete</button>    
                    </ul>
</td> 
</tr>
</table>
